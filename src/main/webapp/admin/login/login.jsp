								...
								<table width="452" height="290" border="0" cellpadding="0" cellspacing="0">
									...
									<tr>
										<td align="center" valign="bottom" background="${pageContext.request.contextPath}/admin/images/loginbg.gif">
											<form id="loginAction_home" name="form1" action="${pageContext.request.contextPath}/admin/login/logincheck" target="_parent" method="post">
												<table border="0" align="center" cellpadding="2" cellspacing="0">
													...
													<tr>
														<td height="30" nowrap colspan="2">
															<c:if test="${msg1!=null}">
																<strong><font color="red"></font>${msg1} </strong>
															</c:if>
															<c:if test="${msg1==null}">
