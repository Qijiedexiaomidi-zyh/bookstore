							...
							<td>
								<table width="100%" border="0" cellspacing="2" class="upline">
									...
									<tr>
										...
										<td><input id="password" name="password" type="password" class="textinput" onkeyup="checkPassword();"/></td>
										<td><span id="passwordMsg"></span><font color="#999999">密码设置至少6位，请区分大小写</font></td>
									</tr>
									<tr>
										<td style="text-align:right">重复密码：</td>
										<td><input id="repassword" type="password" class="textinput" onkeyup="checkConfirm();"/></td>
