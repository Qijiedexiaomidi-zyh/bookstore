				...
				<td width="25%">
					<table width="100%" border="0" cellspacing="0" style="margin-top:30px">
						...
						<tr>
							<td class="listtd">
								<img src="${pageContext.request.contextPath }/client/images/miniicon.gif" width="9" height="6" />&nbsp;&nbsp;&nbsp;&nbsp; 
								<a href="${pageContext.request.contextPath}/client/user/loginout">用戶退出</a>
							</td>
						</tr>
					</table>
				</td>
									...
									<c:forEach items="${orders}" var="order">
										<tr>
											...
											<td class="tableopentd03">
												<a href="${pageContext.request.contextPath}/client/order/findOrderItemById?id=${order.id}">查看</a>&nbsp;&nbsp;
												<c:if test="${order.paystate==0 }">
													<a href="${pageContext.request.contextPath}/client/order/delOrderById?id=${order.id}">刪除</a>
												</c:if> 
												<c:if test="${order.paystate!=0 }">
													<a href="${pageContext.request.contextPath}/client/order/delOrderById?id=${order.id}&flag=1">刪除</a>
												</c:if>
											</td>
										</tr>
									</c:forEach>
